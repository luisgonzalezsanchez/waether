...
/***/ "./resources/js/dashboard/ally.js":
/*!****************************************!*\
  !*** ./resources/js/dashboard/ally.js ***!
  \****************************************/
...
var vm = new Vue({
  ...
  methods: {
    ...
    getList: function getList(page) {
      this._getList(this.setUrl('/dashboard/ally'), page);
    },
    getListSearch: function getListSearch(page) {
      this._getListSearch(this.setUrl('/dashboard/ally/search'), page);
    },
    ...
    createElement: function createElement() {
      this._storeElement(this.setUrl('/dashboard/ally/store'), this._jsonToForm(this.element), '#crear-element');
    },
    ...
    saveElement: function saveElement() {
      ...
      this.openLoading();
      var service = this.setUrl('/dashboard/ally/update/' + this.element.id); //la función _updateElement permite la acutalización de datos
    ...
    confirmDeleteElement: function confirmDeleteElement(elementDelete) {
      ...
      var service = this.setUrl('/dashboard/ally/destroy/') + elementDelete; //borrar el recordatorio
...
/***/ 4:
/*!**********************************************!*\
  !*** multi ./resources/js/dashboard/ally.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\laragon\www\connect-api\resources\js\dashboard\ally.js */"./resources/js/dashboard/ally.js");
