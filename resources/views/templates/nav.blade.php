      <div class="c-sidebar-brand"><img class="c-sidebar-brand-full" src="/img-front/bellpi-logo.png" alt="CoreUI Logo"><img class="c-sidebar-brand-minimized" src="assets/brand/coreui-signet-white.svg" width="118" height="46" alt="CoreUI Logo"></div>
